...
export const updateDoctorZodSchema = z.object({
    ...
    doctor: z.object({
        ...
        contactNumber: z.string().min(10, "Contact number must be at least 10 characters long").max(14, "Contact number must be less than 14 characters long"),
        ...
        experience: z.int().nonnegative("Experience must be a non-negative integer"),
